...
bot.on('message', (msg)=>{
    ...
    if (messageText==="💻Стать программистом!💻"){
        ...
        bot.sendMessage(chatId, "Фронтенд веб-сайта — это все, что пользователь видит и с чем может взаимодействовать" +
            ...
            " совместно работают над этой же частью проект" +
            "\n" +
            "Бэкэнд  - это та часть, которая работает на серверной стороне и отвечает за обработку данных и логику работы" +
            " приложения. Важной задачей бекэнд-разработчиков является обеспечение безопасности приложения, включая защиту" +
