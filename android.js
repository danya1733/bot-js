...
function android1(chatId, bot,){
    bot.sendMessage(chatId,
        ...
        "1990-х годах (позже купленной Oracle). Java находится под влиянием C и C++, поэтому она имеет много общего с этими языками (и C#). Одним из больших преимуществ Java является то, что он «платформенно-независимый». Это означает, что код, который вы пишете на одной платформе, можно легко запустить на другой.\n" +
...
function android7(chatId, bot,){
    bot.sendMessage(chatId,
        "Pet-проект - это индивидуальный проект, который вы делаете ради себя, он создается дома вне остальной деятельности, характеризующийся как исключительно личный фаворит программиста.\n" +
        "\n" +
